        ...
        _getStyle: function(affixType){
            ...
            switch( affixType ){
                case 'VIEWPORT-TOP':
                    ...
                    style.inner = {position: 'fixed',  border: '1px solid #d9dadb', top: this.options.topSpacing,
                ...
                case 'VIEWPORT-UNBOTTOM':
                     style.inner = {position: 'absolute', border: 'none', top: dimensions.containerTop + dimensions.translateY};
            ...
            style.inner = $.extend({}, {position: 'relative', border: 'none', top: '', left: '', bottom: '', width: '',  transform: ''}, style.inner);
