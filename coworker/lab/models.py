...
from coworker.lab.flags import PINGBACK
from coworker.lab.flags import TRACKBACK
from .managers import DRAFT, HIDDEN, PUBLISHED
from .managers import EntryPublishedManager
from coworker.lab.markups import html_format
from coworker.lab.preview import HTMLPreview
from .settings import AUTO_CLOSE_COMMENTS_AFTER
from .settings import AUTO_CLOSE_PINGBACKS_AFTER
from .settings import AUTO_CLOSE_TRACKBACKS_AFTER
from .settings import ENTRY_CONTENT_TEMPLATES
from .settings import ENTRY_DETAIL_TEMPLATES
from .settings import UPLOAD_TO
from tinymce.models import HTMLField

# from coworker.lab.url_shortener import get_url_shortener

from .managers import EntryRelatedPublishedManager
from .managers import entries_published
...
class CoreEntry(models.Model):
    ...
    def get_absolute_url(self):
        ...
        return reverse('lab:entry_detail', kwargs={
