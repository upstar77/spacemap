(function ( $ ) {
  ...
  $.fn.initLogin = function( options ) {
    ...
    logingModal.append($('<div>', {class: 'col-sm-12 col-md-12 col-xs-12 pade_none modal-header'})
               .append('<h2 class="signup_face"><a href="javascript:void(0)" onclick="redirectNavFBForLogin();"> <img src="'+awsUrl+'template/img/login_with_facebook.png" alt="" style="width: 325px;"></a></h2>'));
